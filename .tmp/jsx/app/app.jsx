...
app.view = function(ctrl) {
    ...
    <div class="row marketing">
        ...
        <div class="col-lg-6">
            <h4>Mithril</h4>
            <p>Mithril is a client-side Javascript MVC framework, i.e. its a tool to make application code divided into a data layer (called Model), a UI layer (called View), and a glue layer (called Controller)
